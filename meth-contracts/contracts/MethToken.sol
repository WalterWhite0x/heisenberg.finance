...
// MethToken with Governance.
contract MethToken is ERC20("MethToken", "METH"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "METH::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "METH::delegateBySig: invalid nonce");
        require(now <= expiry, "METH::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "METH::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "METH::_writeCheckpoint: block number exceeds 32 bits");
